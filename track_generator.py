...
class TrackPlaneGenerator():
    ...
    def save(self, idx, path = "C:/Users/teemu/Future_of_iot/line_follower_rl/ai_gym_train/gym_linefollower/models_tracks/"):
    ...
    def _save_urdf(points, plane_color = [10, 11, 12, 13], line_color = [1, 2, 3, 4], file_name_prefix = "C:/Users/teemu/Future_of_iot/line_follower_rl/ai_gym_train/gym_linefollower/models_tracks/file"):
        tree = ET.parse("C:/Users/teemu/Future_of_iot/line_follower_rl/ai_gym_train/gym_linefollower/models/" + "track_plane_template.urdf")
        root = tree.getroot()
...
if __name__ == "__main__":
    ...
    #generator = TrackPlaneGenerator(400, 8.0)
    #generator.save(1000)
    #generator.show()
